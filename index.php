  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            <h1 class="mb-4">DIAGNOSA GINJAL</h1>
            <p class="mb-4">
              DIAGNOSA GINJAL Merupakan sistem informasi berbasis Web yang memanfaatkan teknologi Sistem Pakar 
              untuk membantu pengguna mengidentifikasi atau memeriksakan gejala penyakit GINJAL. Hasil tes akan disajikan dalam bentuk persentase, memberikan 
              gambaran tentang tingkat kemungkinan seseorang terinfeksi GINJAL berdasarkan jawaban yang diberikan. 
              Sistem ini bertujuan untuk memberikan informasi awal kepada pengguna sebelum mengonsultasikan kondisi 
              kesehatan mereka dengan profesional medis.</p>
            <a class="btn btn-primary" href="register.php" role="button">Ayo Mulai!</a>
          </div>
          <div class="col d-none d-sm-block">
            <img width="500" src="gambar/hot.png" alt="hero" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="alur">
      ...
      <div id="konten2" class="container konten">
        <h2 style="font-weight: bold;text-align: center;">Alur Kerja Sistem Pakar DIAGNOSA GINJAL</h2>
        <div class="card-deck">
          <div class="card">
